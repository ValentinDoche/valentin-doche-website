...
function head($title){ ?>
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=0.8, maximum-scale=0.8, user-scalable=no, minimum-scale=0.8">
        <meta name="description" content="Valentin Doche is a student in Web Marketing and Computer Science. Freelance, he is your partner for a digital transition. Future Specialization in E-Sport" />
        <meta name="author" content="Valentin Doche" />
        <!--Favicons-->
        <link rel="shortcut icon" href="/theme/assets/images/favicon.webp">
        <!--Page Title-->
